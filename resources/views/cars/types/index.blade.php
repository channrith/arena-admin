    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">List of vehicle types</h3>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="project-actions text-right">
                                <a class="btn btn-primary btn-sm" href="{{ route('cars.types.edit', $vehicle->id) }}">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $('.btn-delete').on('click', function() {
            ...
            modalTitle.textContent = title ? `Vehicle Type: "${title}"` : '';
            deleteForm.action = `/vehicle-types/${itemId}`; // RESTful route
        });
    });
</script>
@endpush