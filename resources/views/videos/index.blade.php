                ...
                <table class="table table-hover text-nowrap projects">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @foreach ($video->services as $service)
                                <span class="badge badge-secondary">{{ $service->description }}</span>
                                @endforeach
                            </td>
                            <td>
                            ...
                            <td class="project-actions text-right">
                                <a class="btn btn-primary btn-sm" href="{{ route('videos.edit', $video->id) }}">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $('.btn-delete').on('click', function() {
            ...
            modalTitle.textContent = title ? `Video: "${title}"` : '';
            deleteForm.action = `/videos/${id}`; // RESTful route
        });
    });
</script>
@endpush